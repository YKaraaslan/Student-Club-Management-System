 ...
 */
public class FinanceFirstAdapter extends Adapter<FinanceFirstAdapter.FinanceFirstViewHolder> {
    ...
    public FinanceFirstAdapter(Context mCtx, List<FinanceItem> exampleList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    public FinanceFirstViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FinanceFirstViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view, parent, false), this.mCtx, this.financeList);
    }

    public void onBindViewHolder(@NonNull FinanceFirstViewHolder holder, int position) {
    ...
    public class FinanceFirstViewHolder extends ViewHolder {
        ImageView image;
        TextView textView1;
        TextView textView2;
        Context context;
        ...
        public FinanceFirstViewHolder(@NonNull View itemView, final Context context, final List<FinanceItem> financeItemList) {
            super(itemView);
            ...
            itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context, FinanceFirstShow.class);
