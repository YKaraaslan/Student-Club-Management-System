 ...
 */
public class UserProfileFromUserList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_profile_from_user_list);
        Slidr.attach(this);
        init();
    }
    ...
    private void init() {
        ...
        UsersItems usersItems = (UsersItems) getIntent().getSerializableExtra("user");
        userId = usersItems.getId();

        name.setText(usersItems.getName());
        position.setText(usersItems.getPosition());
    ...
    private void setProfile(final int userId) {
        new AsyncTask<String, String, String>() {
            ...
            protected void onPostExecute(String s) {
                switch (s) {
                    case "false":
                        Toast.makeText(UserProfileFromUserList.this, connection, Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case "done":
                        ...
                        if (Integer.valueOf(postAmountString) == 0) {
                            userPostsLinear.setVisibility(View.GONE);
