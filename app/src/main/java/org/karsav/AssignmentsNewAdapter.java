 ...
 */
public class AssignmentsNewAdapter extends Adapter<AssignmentsNewAdapter.AssignmentsNewViewHolder> {
    ...
    public AssignmentsNewAdapter(Context mCtx, List<AssignmentsItem> exampleList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    public AssignmentsNewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AssignmentsNewViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view, parent, false), this.mCtx, this.assignmentsItemList);
    }

    public void onBindViewHolder(@NonNull AssignmentsNewViewHolder holder, int position) {
        AssignmentsItem currentItem = assignmentsItemList.get(position);
        String content = currentItem.getContent().trim() + "\n\n" + currentItem.getResponsibleName() + " - " + currentItem.getDateOfIssue();
    ...
    public class AssignmentsNewViewHolder extends ViewHolder {
        ImageView image;
        TextView textView1;
        TextView textView2;
        Context context;
        ...
        public AssignmentsNewViewHolder(@NonNull View itemView, final Context context, final List<AssignmentsItem> assignmentsItemsList) {
            super(itemView);
            ...
            itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context, AssignmentsNewShow.class);
