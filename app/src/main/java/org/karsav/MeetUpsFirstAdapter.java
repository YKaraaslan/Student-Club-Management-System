 ...
 */
public class MeetUpsFirstAdapter extends Adapter<MeetUpsFirstAdapter.MeetUpsFirstViewHolder> {
    ...
    public MeetUpsFirstAdapter(Context mCtx, List<MeetUpsItem> exampleList) {
        this.mCtx = mCtx;
    ...
    public class MeetUpsFirstViewHolder extends ViewHolder {
        ...
        public MeetUpsFirstViewHolder(@NonNull View itemView, final Context context, final List<MeetUpsItem> meetUpsItemList) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context, MeetUpsShow.class);
