 ...
 */
public class AssignmentsDoneAdapter extends Adapter<AssignmentsDoneAdapter.AssignmentsDoneViewHolder> {
    ...
    public AssignmentsDoneAdapter(Context mCtx, List<AssignmentsItem> exampleList) {
        this.mCtx = mCtx;
    ...
    @NonNull
    public AssignmentsDoneViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AssignmentsDoneViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view, parent, false), this.mCtx, this.assignmentsItemList);
    }

    public void onBindViewHolder(@NonNull AssignmentsDoneViewHolder holder, int position) {
    ...
    public class AssignmentsDoneViewHolder extends ViewHolder {
        ImageView image;
        TextView textView1;
        TextView textView2;
        Context context;
        ...
        public AssignmentsDoneViewHolder(@NonNull View itemView, final Context context, final List<AssignmentsItem> assignmentsItemsList) {
            super(itemView);
